...
class ApiCall(private val context: Context, private val geminiApiKey: String) {
    companion object {
        private const val API_URL = "https://fastapi.metaskepsis.com/talk_to_agents/"
        private const val TAG = "ApiCall"
        private const val MY_SOCKET_TIMEOUT_MS = 30000 // 30 seconds
        private const val MY_MAX_RETRIES = 2
    }
    ...
    fun sendTextToApi(text: String, speakerId: Int, callback: ApiCallCallback) {
